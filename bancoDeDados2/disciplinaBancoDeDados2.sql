...
-- a maioria bancos nao o impliementam:
READ UNCOMMITED
/*
 * NIVEL MAIS BRANDO
 * NAO BLOQUEIA NA LEITURA E NA GRAVACAO
 * PERMITE A LEITURA DE DADOS NAO EFETIVADOS
 * HA GANHO DE PERFORMANCE, MAS PERDA DE SEGURANCA
 */

-- nivel padrao de bancos de dados
READ COMMITED
/*
 * SE UMA TRANSACAO ALTERA UM DADO, AQUELE DADO ALTERADO FICA BLOQUEADO ATE O __COMITED__
 * SE FOR APENAS LEITURA, APOS O SELECT O DADO EH LIBERADO
 * EVITA LEITURA SUJA E ATUALIZACAO PERDIDA (MAOIR PARTE DOS PROBLEMAS)
 */

-- bloqueia leitura e gravacao ate o __commited__:
REPEATABLE READ
/*
 * 
 */
 ...
 * INSERCOES OU DELECOES NAO PODEM SER FEITAS EM CONJUNTO
 */
...
-- LISTAGEM DAS OPCOES DO CLUSTER DO SQLSERVER
DBCC USEROPTIONS

-- MUDAR O NIVEL DE ISOLAMENTO DA SECAO
SET TRANSACTION ISOLATION LEVEL SERIALIZABLE

-- TROCA O NIVEL DE ISOLACAO NUMA TABELA ESPECIFICA
ALTER DATABASE master SET READ_COMMITED_SNAPSHOT ON
ALTER DATABASE master SET READ_ ON
